...
int main(int argc, char *argv[])
{
  ...
  18:	7dc50513          	addi	a0,a0,2012 # 7f0 <malloc+0xea>
  1c:	00000097          	auipc	ra,0x0
  20:	632080e7          	jalr	1586(ra) # 64e <printf>
	hello(n);
  24:	8526                	mv	a0,s1
  26:	00000097          	auipc	ra,0x0
  2a:	346080e7          	jalr	838(ra) # 36c <hello>
	exit(0);
  2e:	4501                	li	a0,0
  30:	00000097          	auipc	ra,0x0
  34:	29c080e7          	jalr	668(ra) # 2cc <exit>
	if (argc >= 2) n=atoi(argv[1]);
  38:	6588                	ld	a0,8(a1)
  3a:	00000097          	auipc	ra,0x0
  3e:	198080e7          	jalr	408(ra) # 1d2 <atoi>
  42:	84aa                	mv	s1,a0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	4b050513          	addi	a0,a0,1200 # 868 <digits>
 3c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47c:	398c8c93          	addi	s9,s9,920 # 810 <malloc+0x10a>
 ...
 48a:	3e2b8b93          	addi	s7,s7,994 # 868 <digits>
 ...
 5b0:	25c98993          	addi	s3,s3,604 # 808 <malloc+0x102>
        while(*s != 0){
 5b4:	85ee                	mv	a1,s11
